...
#get the source code
git clone $branch https://github.com/fusionpbx/fusionpbx.git /opt/pbx/www/fusionpbx
chown -R www-data:www-data /opt/pbx/www/fusionpbx
ln -s /opt/pbx/www/fusionpbx  /var/www/
