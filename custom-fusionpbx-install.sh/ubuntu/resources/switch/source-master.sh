...
./bootstrap.sh -j
#./configure --disable-fhs --prefix=/opt/pbx --enable-core-pgsql-support --disable-fhs
./configure -C --enable-portable-binary --disable-dependency-tracking \
--prefix=/opt/pbx --localstatedir=/opt/pbx/var --sysconfdir=/opt/pbx/conf \
...
mkdir -p /opt/pbx/sounds/music/default
mv /usr/local/freeswitch/sounds/music/*000 /opt/pbx/sounds/music/default
